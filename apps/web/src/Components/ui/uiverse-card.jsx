...
const socialItems = [
  { name: "Instagram", href: "https://www.instagram.com/expograph_tech/", label: "Follow us on Instagram", delay: "0.1s" },
  { name: "YouTube", href: "https://www.youtube.com/@Expograph-3", label: "Subscribe on YouTube", delay: "0.2s" },
  { name: "LinkedIn", href: "https://www.linkedin.com/company/109629393/", label: "Connect on LinkedIn", delay: "0.3s" },
];
            ...
            <div className="social-panel-content">
              ...
              <div className="social-panel-items">
                {socialItems.map((item, i) => (
                  <a key={item.name} href={item.href} target="_blank" rel="noopener noreferrer" className="social-panel-item" style={{ animationDelay: item.delay }}>
