    ...
    >
      <div className="container mx-auto grid grid-cols-1 items-center gap-8 sm:gap-10 lg:grid-cols-2 lg:gap-8">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          <h1
            className={cn(
              "text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-foreground animate-[fadeInUp_0.5s_ease-out_both]",
              titleClassName
            )}
          ...
          <p className="mt-4 sm:mt-6 max-w-md text-base sm:text-lg text-muted-foreground px-2 sm:px-0 animate-[fadeInUp_0.5s_0.2s_ease-out_both]">
            {subtitle}
          </p>
          <div className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-3 sm:gap-4 lg:justify-start animate-[fadeInUp_0.5s_0.4s_ease-out_both]">
          ...
          <div className="mt-8 sm:mt-12 flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8 lg:justify-start animate-[fadeInUp_0.5s_0.6s_ease-out_both]">
        ...
        <div className="relative h-[360px] w-full min-h-0 sm:h-[400px] md:h-[450px] lg:h-[500px] mt-6 lg:mt-0">
          ...
          <div
            className="absolute left-1/2 top-0 h-40 w-40 sm:h-44 sm:w-44 md:h-48 md:w-48 lg:h-52 lg:w-52 xl:h-64 xl:w-64 -translate-x-1/2 rounded-xl bg-muted p-1.5 sm:p-2 shadow-lg animate-[scaleIn_0.5s_0.2s_ease-out_both]"
          >
            <img
              src={images[0]}
          ...
          <div
            className="absolute right-0 top-[28%] sm:top-1/3 h-36 w-36 sm:h-40 sm:w-40 md:h-44 md:w-44 lg:h-56 lg:w-56 rounded-xl bg-muted p-1.5 sm:p-2 shadow-lg animate-[scaleIn_0.5s_0.4s_ease-out_both]"
          >
            <img
              src={images[1]}
              alt="Tutor assisting"
          ...
          <div
            className="absolute bottom-0 left-0 h-32 w-32 sm:h-36 sm:w-36 md:h-40 md:w-40 lg:h-48 lg:w-48 rounded-xl bg-muted p-1.5 sm:p-2 shadow-lg animate-[scaleIn_0.5s_0.6s_ease-out_both]"
          >
            <img
              src={images[2]}
