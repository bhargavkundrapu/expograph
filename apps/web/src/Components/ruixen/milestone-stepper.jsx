...
function MilestoneItem({
  ...
  return (
    <motion.div
      ...
      {/* Content */}
      <div
        className={cn("flex-1 min-w-0", variant === "compact"
          ? "pb-3"
          : variant === "detailed"
            ? "pb-8"
            : "pb-6")}>
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            {milestone.description && variant !== "compact" && (
              <p
                className={cn("mt-1 text-[12px] leading-relaxed", state === "upcoming"
                  ? "text-foreground/20"
                  : "text-foreground/40")}>
          ...
          {milestone.date && (
            <span
              className={cn("shrink-0 text-[11px] font-medium tabular-nums", state === "upcoming"
                ? "text-foreground/20"
                : "text-foreground/30")}>
              {milestone.date}
            </span>
