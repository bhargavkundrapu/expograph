...
- 🎯 Specify art styles and visual references so the AI doesn't guess
- 🎯 Control lighting type and direction to set the mood of your image
- 🎯 Combine multiple style references into one cohesive image prompt
...
You want an illustration for your blog, but the AI gives you a photorealistic render when you wanted a hand-drawn sketch. Or you need a warm, golden-hour portrait, but you get harsh midday lighting. Style and lighting are what make an image feel intentional. Master these, and your AI-generated visuals will look like a designer made them.
...
Output:
```
A generic photorealistic image of a forest with a small river
running through it. Standard green trees, blue water. Flat
midday lighting with no shadows. Looks like a default wallpaper
from 2010. No particular art style or mood.
```
...
Output:
```
A stunning impressionist oil painting of a dense forest. A river
...
**What changed**: Combined two style references (impressionism + Studio Ghibli) into one prompt and added volumetric light rays for a more dramatic, layered look.
...
Lighting: Rim light from behind (backlit), with a single blue light on the left side of the face
...
Lighting: Warm interior glow spilling out of the shop windows onto the wet sidewalk
...
You're making a cover image for a personal blog about late-night coding sessions. Write an image prompt that captures the "coding at 2 AM" vibe. Include: subject, a specific art style, a lighting setup (think screen glow + desk lamp), a color palette, and mood. The image should make someone feel the quiet focus of a late-night session.

---

## SEC-11: ✅ Checklist
Before moving on, confirm:
- [ ] I can specify at least three different art styles in a prompt
- [ ] I can write a prompt that controls lighting type and direction
- [ ] I tried the guided practice with two different styles
...
## SEC-13: 📋 Mini Quiz
**Q1**: What happens when you don't specify a style in your image prompt?
- A) The AI always generates a watercolor
