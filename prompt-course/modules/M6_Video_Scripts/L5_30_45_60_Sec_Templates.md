...
- Use three ready-made script templates for 30s, 45s, and 60s videos
- Match your script structure to the right video duration
- Optimize your template for different platforms (Instagram, YouTube, LinkedIn)
...
Hey everyone! Today I want to share something cool with you.
So I recently discovered this amazing thing and I think you'll
love it too. It's really great and I've been using it a lot.
Anyway, hope you enjoyed this. See you next time!
```
...
For each template:
- Show the structure with time stamps
- Fill in a sample script using the topic "why you should learn
  prompt engineering"
...
results from ChatGPT. One good prompt can replace an hour of
...
in college, internships, and your first job.
[0:54–0:60] CTA: "Comment 'PROMPT' and I'll send you my free
template pack."
```
...
Prompt:
```
Give me 3 video script templates (30s, 45s, 60s) on the topic
"why you should learn prompt engineering."

Use the same structure as before, but now optimize each template
for a specific platform:

- 30s template → Instagram Reels (fast cuts, bold hook,
  visual-first, CTA: "save this")
- 45s template → YouTube Shorts (slightly more depth,
  story-style, CTA: "subscribe")
- 60s template → LinkedIn Video (professional tone, data-backed,
  CTA: "comment your thoughts")

For each template include:
- Timestamps
- Sample script
- Platform-specific tips (2 bullet points)
- Recommended text overlay for the hook
...
1. Pick a topic you want to post about (a skill, a hack, a tool)
2. Choose one duration: 30s, 45s, or 60s
3. Write a prompt asking for a script using the matching template structure

**Your task**: Generate a 45-second script about "3 things I wish I knew in first year of college." Use the 45-second template structure with timestamps and a CTA.
...
Create all three templates (30s, 45s, 60s) for the topic "How to use ChatGPT for exam prep." Each template must have timestamps, a sample script, and a platform-specific CTA (Instagram for 30s, YouTube for 45s, LinkedIn for 60s). Run the prompt, read the output aloud, and check that each script fits its time limit.

---

## SEC-11: ✅ Checklist
Before moving on, confirm:
- [ ] I understand the structure differences between 30s, 45s, and 60s templates
- [ ] I can write a prompt that generates a duration-specific script with timestamps
...
## SEC-13: 📋 Mini Quiz
**Q1**: How many key points should a 30-second video script typically have?
- A) Three
- B) One
- C) Five
...
> Pick your duration, follow the template, and you'll never stare at a blank screen before filming again.
