...
[1–3 sentences explaining a real student scenario where this skill matters.
Connect to: study / coding / projects / placements / resume / interviews / career]
...
Prompt:
```
[The improved prompt using the lesson's framework/technique]
```
...
**Your task**: [Clear, specific task the student does right now]
...
[A specific task that tests the lesson's skill. Must be doable in 5 minutes.
Include the exact scenario and what the student should produce.]
...
- [ ] I can write a prompt that [skill 1]
...
**Answer**: [correct answer + one line explanation]
...
> [One powerful sentence that summarizes the entire lesson. Memorable. Quotable.]
```
